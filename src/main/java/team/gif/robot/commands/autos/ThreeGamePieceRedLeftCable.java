...
public class ThreeGamePieceRedLeftCable extends SequentialCommandGroup {

    public ThreeGamePieceRedLeftCable() {
        PathPlannerTrajectory trajectory = PathPlanner.loadPath("3 GP Red Left Cable", 1.6, 3.0); // 1.8 1.2
        ...
        addCommands(
            new PrintCommand("Auto: 3 GP Red Left Cable"),
//                new WheelsOut(),
